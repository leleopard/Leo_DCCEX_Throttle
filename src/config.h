...
// ---------------------------------------------------------------------------
// Extra push buttons
// Pins freed from encoders 3 & 4 (previously GPIO 21/22 were ENC4 CLK/DT)
// ---------------------------------------------------------------------------
#define BTN_ROSTER  22   // Toggle roster screen
#define BTN_ESTOP   21   // Emergency stop
...
// ---------------------------------------------------------------------------
#define TOUCH_CS_PIN   13   // T_CS  — freed from ENC3_SW
